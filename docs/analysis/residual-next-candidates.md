...
| P0-585 | Channel failure cascade poison | **partial** (hardened #299/#302; honesty #336) | Channel-scoped exclude, 429 failover, same-channel timeout budget, isolation tests (`docs/analysis/failover-isolation.md`). Residual: intentional site/model breaker + empty-filter fallback + **no production multi-channel load proof** | Optional load-test / breaker polish with ACs only | Medium residual |
