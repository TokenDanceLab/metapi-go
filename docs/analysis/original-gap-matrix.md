...
| 489 | Codex OAuth first model discovery timeout (12s) | feature-protocol | partial | OAuth model discovery status in `service/oauth/account.go`; timeout constants need runtime confirm | P1 | yes |
