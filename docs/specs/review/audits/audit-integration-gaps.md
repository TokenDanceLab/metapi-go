...
- `D:/Code/TokenDance/metapi-go/e2e/e2e_test.go` (1200 lines, 13 tests)
- `D:/Code/TokenDance/metapi-go/service/oauth/flow_test.go` (554 lines)
- `D:/Code/TokenDance/metapi-go/service/oauth/import_test.go` (507 lines)
- `D:/Code/TokenDance/metapi-go/service/checkin/checkin_test.go` (329 lines)
- `D:/Code/TokenDance/metapi-go/handler/admin/accounts_test.go` (794 lines)
- `D:/Code/TokenDance/metapi-go/handler/admin/edge_cases_test.go` (907 lines)
- `D:/Code/TokenDance/metapi-go/handler/admin/settings_backup.go` (338 lines, zero tests)
- `D:/Code/TokenDance/metapi-go/handler/admin/settings_maintenance.go` (155 lines, zero tests)
- `D:/Code/TokenDance/metapi-go/auth/ratelimit.go` (120 lines, zero tests)
- `D:/Code/TokenDance/metapi-go/store/migrate_test.go` (247 lines)
- `D:/Code/TokenDance/metapi-go/store/postgres_test.go` (conditional, env-dependent)
- `D:/Code/TokenDance/metapi-go/store/sqlite_test.go` (no test functions with standard naming)
- `D:/Code/TokenDance/metapi-go/service/site_service_test.go` (501 lines)
- `D:/Code/TokenDance/metapi-go/service/account_mutation_test.go` (561 lines)
- `D:/Code/TokenDance/metapi-go/routing/cooldown_test.go` (471 lines)
- `D:/Code/TokenDance/metapi-go/proxy/profiles_test.go` (501 lines)
