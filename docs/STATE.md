...
| Active milestone | **[51 UI-REFRESH](https://github.com/TokenDanceLab/metapi-go/milestone/51)** (Phase 1–2 + token density in tree, unreleased) |
...
| UI-REFRESH | **in tree unreleased** | FOUC · DS gallery · Playwright · shell glass · GCP tokens/cards; Linux baselines + page screenshots residual |
